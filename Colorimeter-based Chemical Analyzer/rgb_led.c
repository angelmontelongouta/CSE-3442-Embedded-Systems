...
void initRgb()
{
    ...
    PWM1_1_CTL_R = 0;                                // turn-off PWM1 generator 2 (drives outs 4 and 5)
                                                     // turn-off PWM1 generator 3 (drives outs 6 and 7)
    PWM0_1_CTL_R = 0;
    ...
    PWM1_1_CMPA_R = 0;                               // red off (0=always low, 1023=always high)
    PWM1_1_CMPB_R = 0;                               // green off
    PWM0_1_CMPA_R = 0;                               // blue off

    PWM1_1_CTL_R = PWM_0_CTL_ENABLE;                 // turn-on PWM1 generator 2
               // turn-on PWM1 generator 3
